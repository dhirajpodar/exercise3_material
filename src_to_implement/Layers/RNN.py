...
class RNN(BaseLayer):
    ...
    def forward(self, input_tensor):
        ...
        for i in range(batch_size):
            ...
            self.tan_activation[i] = self.tanh.activations
    ...
    def backward(self, error_tensor):
        ...
        while time_step >= 0:  # can use np.flip(error_tensor, axis=0)
            ...
            self.tanh.activations = self.tan_activation[time_step, None]
            tanh_error = self.tanh.backward(gradiant_pass_to_tanh)
